...
namespace ReplicatedSite.Filters
{
    ...
    public class ContentManagerAdminsFilter : AuthorizeAttribute
    {
        ...
        {
            //Response = Identity.Customer != null && Identity.Customer.CustomerTypeID == Common.CustomerTypes.Master;
            Response = Identity.Customer != null && Identity.Customer.CustomerTypeID == Common.CustomerTypes.PreferredCustomer;
            return Response;
        }
