...
namespace Backoffice.Controllers
{
    public class AutoOrdersController : Controller
    {
        ...
        public ActionResult AutoOrderList()
        {
            ...
            viewModel.AutoOrders = Exigo.GetCustomerAutoOrders(Identity.Current.CustomerID, includePaymentMethods: false);
        ...
        public ActionResult ManageAutoOrder(int id)
        {
            ...
            var market              = GlobalSettings.Markets.AvailableMarkets.Where(c => c.Countries.Contains(Identity.Current.Country)).FirstOrDefault();
            ...
            {
                var customerShippingAddress = customer.ShippingAddresses.Where(a => a.IsComplete && a.Country == Identity.Current.Country).FirstOrDefault();
                ...
                viewModel.AutoOrder = new AutoOrder()
                {
                    ...
                    ShippingAddress        = (customerShippingAddress != null) ? customerShippingAddress : new ShippingAddress() { Country = Identity.Current.Country },
            ...
            if (isExistingAutoOrder)
            {
                var calculateOrderResponse = Exigo.CalculateOrder(new OrderCalculationRequest
                {
                    ...
                    Configuration     = Identity.Current.Market.Configuration.BackOfficeAutoOrders,
        ...
        public ActionResult ManageAutoOrder(int id, ManageAutoOrderViewModel viewModel)
        {
            ...
            var isExistingAutoOrder = id != 0;
            var paymentMethods = Exigo.GetCustomerPaymentMethods(new GetCustomerPaymentMethodsRequest() { CustomerID = Identity.Current.CustomerID, ExcludeIncompleteMethods = true });
