...
namespace Backoffice.HtmlHelpers
{
    public static class EditorHtmlHelpers
    {
        ...
        {
            string siteDescription = Common.ContentSites.Backoffice;
            ...
            int customerTypeID = !HttpContext.Current.User.Identity.IsAuthenticated ? 0 : (HttpContext.Current.User.Identity as UserIdentity).CustomerTypeID;
